...
VOID CDataBaseSystem::OpenAllDataBase(VOID)
{
	...
	_DATABASE_DEFINE  s_dbToLoad[] = 
	{
		...
		{ DBC_CHARACTER_MODEL,			"CharModelEx.txt"		},//
		{ DBC_CHARACTER_MOUNT,			"CharMount.txt"			},
		{ DBC_MISSION_LIST,				"MissionOutline.txt"	},
		{ DBC_MISSION_DATA,				"MissionData.txt"		},
		{ DBC_MISSION_REWARD,			"Mission_LootItem.txt"		},//
		{ DBC_MISSION_PUNISH,			"Mission_EnterArea.txt"		},//
		{ DBC_MISSION_DIALOG,			"MissionNPC_HashTable.txt"		},//
		...
		{ DBC_SCENE_DEFINE,				"SceneDefineEx.txt"		},//
		{ DBC_SCENE_POS_DEFINE,			"ScenePosDefine.txt"	},
		{ DBC_UI_LAYOUTDEFINE,			"InterfaceEx.txt"		},//
