...
//void Listbox::ResetSize()
//{
//	float fWidth = getAbsoluteWidth();
//	float fHeight = getTotalItemsHeight();
//	
//	float f1 = System::getSingleton().getRenderer()->getHeight();
//	float f2 = getPixelRect().getHeight();
//	float fMaxHeight = System::getSingleton().getRenderer()->getHeight() - getPixelRect().getHeight();
//
...
/*************************************************************************
	Set the select state of an attached ListboxItem.	
	Set the select state by itemid
*************************************************************************/
