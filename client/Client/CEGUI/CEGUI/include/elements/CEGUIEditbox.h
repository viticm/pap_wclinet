...
public:
	...
	*************************************************************************/
	...
	static const String EventTextAccepted;				//!< The user has accepted the current text by pressing Return, or Enter.
	static const String EventTabPressed;				//!< The user has pressed Tab.
...
protected:
	...
	*/
	...
	/*!
	\brief
		Event fired internally when the user accepts the edit box text by pressing Return or Enter.
	*/
	virtual	void	onTextAcceptedEvent(WindowEventArgs& e);

	/*!
	\brief
		Event fired internally when the user pressed Tab.
	*/
