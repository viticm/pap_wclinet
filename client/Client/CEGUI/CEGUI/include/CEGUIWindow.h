...
public:
	...
	*************************************************************************/
	// generated internally by Windowf
	...
	static const String EventParentHidden;				//!< Window's parent has been hidden from view
	...
	static const String EventMouseLButtonDown;			//!< A mouse left button was pressed down within the Window.
	static const String EventMouseRButtonDown;			//!< A mouse right button was pressed down within the Window.
	...
	*************************************************************************/
	/*!
	\brief
		return a String object holding the type widget name for this Window.

	\return
		String object holding the Window widget type.
	*/
	...
	*/
	const FontBase*		getFont(bool useDefault = true) const;

	/*!
	\brief
		return true if a child window ignore all mouse input events.

	\return
		true if all mouse input events whill be ignore by this window, else false.
	*/
	...
	/*!
	\brief
		return true if a child window ignore all mouse l-button input events.

	\return
		true if all mouse l-button input events whill be ignore by this window, else false.
	*/
	const bool		getMouseLButtonHollow(void) const		{return d_mouseLButtonHollow;}

	/*!
	\brief
		return true if a child window ignore all mouse r-button input events.

	\return
		true if all mouse r-button input events whill be ignore by this window, else false.
	*/
	...
	*/
	...
	/*!
	\brief
		Set the mousehollow set for the Window.

	\param bool
		true if the Window should ignore all mouse input.

	\return
		Nothing
	*/
	void	setMouseHollow(bool mousehollow);

	void	setMouseMoveHollow(bool mousehollow);

	/*!
	\brief
		Set the mouselbuttonhollow set for the Window.

	\param bool
		true if the Window should ignore all l-button mouse input.

	\return
		Nothing
	*/
	void	setMouseLButtonHollow(bool mousehollow);

	/*!
	\brief
		Set the mouserbuttonhollow set for the Window.

	\param bool
		true if the Window should ignore all r-button mouse input.

	\return
		Nothing
	*/
	void	setMouseRButtonHollow(bool mousehollow);
    ...
    */
	...
	/*!
	\brief
		Checks to see if a Property with the given name is in the Window.

	\param name
		String containing the name of the Property to check for.

	\return
		true if a Property named \a name is in the Window.  false if no Property named \a name is in the Window.
	*/
	bool	isPropertyPresent(const String& name) const;

	/*!
	\brief
		Gets the current value of the specified Window.
	...
	*/
	...
	/*!
	\brief
		Sets the current value of a Window property.
	...
	\exception UnknownObjectException	Thrown if no Property named \a name is in the Window Static Propertyset and Dynamic Propertyset.
	...
	*/
	...
	void setUserSharp(UserSharps us) {d_userSharp = us;}
protected:
	/*************************************************************************
	...
	*/
	...
	/*!
	\brief
		Handler called when the window's parent is hidden.
	...
	*/
	...
	/*!
	\brief
		Prepare all big character texture.
    ...
    */
    ...
    /*!
    \brief
        return True if this window hollow this mousebutton.
    */
	...
	*************************************************************************/
	...
	const FontBase*	d_font;				//!< Holds pointer to the Window objects current Font.
	bool			d_mouseHollow;		//!< true when Window ignore all mouse input events.
	bool			d_mouseMoveHollow;
	bool			d_mouseLButtonHollow;	//!< true when Window ignore all l-button mouse input events.
    bool			d_mouseRButtonHollow;	//!< true when Window ignore all r-button mouse input events.
	String			d_textOriginal;		//!< Orininal text
...
protected:
	...
	*************************************************************************/
	...
	WindowFactory* d_windowFactory; //!< Windowfactory of mine.
	UserSharps d_userSharp;
