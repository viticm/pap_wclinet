...
public:
	...
	*/
	System(Renderer* renderer, const utf8* logFile = (const utf8*)"UISystem.log");
	...
	\param logFile
		pointer to a utf8 encoded buffer containing the name to use for the log file.
	*/
    System(Renderer* renderer, ResourceProvider* resourceProvider, const utf8* logFile = (const utf8*)"UISystem.log");
	...
	*/
    ...
    \param logFile
        pointer to a utf8 encoded buffer containing the name to use for the log file.
    */
    System(Renderer* renderer, XMLParser* xmlParser, const utf8* logFile = (const utf8*)"UISystem.log");
    ...
    \param logFile
        pointer to a utf8 encoded buffer containing the name to use for the log file.
    */
    System(Renderer* renderer, ResourceProvider* resourceProvider, XMLParser* xmlParser, const utf8* logFile = (const utf8*)"UISystem.log");
	...
	*/
	...
	\return
		Nothing.
	*/
	void	setDefaultFont(FontBase* font);
	...
	*/
	FontBase*	getDefaultFont(void) const				{return d_defaultFont;}
...
public:
	...
	*/
	Window*	getTargetWindow(const Point& pt, int nEventType = 0 ) const;
...
private:
	...
	*************************************************************************/
	...
	FontBase*	d_defaultFont;		//!< Holds a pointer to the default GUI font.
