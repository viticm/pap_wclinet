    ...
    */
    ...
    private:
        ...
        *************************************************************************/
		...
		static const String ImagesetBinElement;				//!< Element specifying all Imageset
		...
		static const String TypeAttribute;					//!< Attribute specifying the type of font object.
		...
		static const char	FontType_FreeType[];			//!< Attribute value that stores 'FreeType' for the Font.
		static const char	FontType_Bitmap[];				//!< Attribute value that stores 'Bitmap' for the Font.

		static const String FontBlinkTimeElement;			//!< Element specifying a blink time of all fonts.
		static const String	SecondsAttribute;				//!< Attribute specifying the seconds of blinking.
        /*************************************************************************
        Implementation Data
        *************************************************************************/
