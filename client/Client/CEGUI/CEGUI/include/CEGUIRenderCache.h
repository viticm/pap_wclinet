    ...
    public:
        ...
        */
        ...
        \return
            Nothing
        */
        void render(const Point& basePos, float baseZ, const Rect& clipper, UserSharps bMenualSharp) const;
        ...
        */
        ...
        \return
            Nothing
        */
        void cacheText(const Window* OwnerWindow, const String& text, const FontBase* font, TextFormatting format, const Rect& destArea, float zOffset, const ColourRect& cols, const Rect* clipper = 0, bool clipToDisplay = false, float fScaleX = 1.0, float fScaleY = 1.0 );
