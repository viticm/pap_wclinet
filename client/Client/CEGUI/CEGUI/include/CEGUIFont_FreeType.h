...
*************************************************************************/
#ifndef _CEGUIFontFreeType_h_
#define _CEGUIFontFreeType_h_
...
class CEGUIEXPORT Font_FreeType : public FontBase
{
...
private:
	...
	*/
	Font_FreeType(const String& filename, const String& resourceGroup, FontImplData* dat);
