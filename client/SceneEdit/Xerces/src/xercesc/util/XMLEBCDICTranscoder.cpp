...
//
//  gFromTable
//      This is the translation table for IBM037 EBCDIC to Unicode. This
//      table contains 255 entries. The entry for EBCDIC byte x is the
//      Unicode translation of that byte.
//
//  gToTable
//  gToTableSz
//      This is the translation table for Unicode to IBM037 EBCDIC. This one
...
//      field is the IBM037 code point to translate to.
// ---------------------------------------------------------------------------
...
static const XMLTransService::TransRec gToTable[] =
{
  ...
  , { 0x00AC, 0x5F }, { 0x00AD, 0xCA }, { 0x00AE, 0xAF }, { 0x00AF, 0xBC }
  ...
  , { 0xFF3B, 0xBA }, { 0xFF3C, 0xE0 }, { 0xFF3D, 0xBB }, { 0xFF3E, 0xB0 }
...
// ---------------------------------------------------------------------------
//  XMLEBCDICTranscoder: Public, static methods
// ---------------------------------------------------------------------------
XMLCh XMLEBCDICTranscoder::xlatThisOne(const XMLByte toXlat)
{
