...
#define OGRE_MEMMANAGER_STRESS_TEST 0
    ...
    */
    ...
    // ---------------------------------------------------------------------------------------------------------------------------------
    void *MemoryManager::op_new_sc( size_t reportedSize, unsigned processID, bool disableThrowException )
    {
        // Save these off...
        ...
        for(;;)
        {
            ...
            // If disable throw exception, return 0
            else if (disableThrowException)
            {
                return 0;
            }
    ...
    // ---------------------------------------------------------------------------------------------------------------------------------
    void *MemoryManager::op_new_vc( size_t reportedSize, unsigned processID, bool disableThrowException )
    {
        // Save these off...
        const    char        *file = sourceFile;
        const    unsigned int line = sourceLine;
    ...
    // ---------------------------------------------------------------------------------------------------------------------------------
    void *MemoryManager::op_new_sc( size_t reportedSize, const char *sourceFile, int sourceLine, unsigned processID, bool disableThrowException )
    {
    ...
    // ---------------------------------------------------------------------------------------------------------------------------------
    void *MemoryManager::op_new_vc(size_t reportedSize, const char *sourceFile, int sourceLine, unsigned processID, bool disableThrowException )
    {
