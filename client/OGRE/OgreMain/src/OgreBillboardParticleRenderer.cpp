...
namespace Ogre {
    ...
    BillboardParticleRenderer::CmdSpeedRelativedSizeFactor BillboardParticleRenderer::msSpeedRelativedSizeFactorCmd;
    //-----------------------------------------------------------------------
    BillboardParticleRenderer::BillboardParticleRenderer()
        : mBillboardSet()
        , mSpeedRelativedSizeFactor(0.01f)
    {
        ...
        mBillboardSet = new BillboardSet(StringUtil::BLANK, 0, true);
        // World-relative axes
	...
	//-----------------------------------------------------------------------
	void BillboardParticleRenderer::setSpeedRelativedSizeFactor(Real factor)
	{
		mSpeedRelativedSizeFactor = factor;
	}
	//-----------------------------------------------------------------------
	Real BillboardParticleRenderer::getSpeedRelativedSizeFactor(void) const
	{
		return mSpeedRelativedSizeFactor;
	}
    //-----------------------------------------------------------------------
    //-----------------------------------------------------------------------
    //-----------------------------------------------------------------------
    ...
    //-----------------------------------------------------------------------
    String BillboardParticleRenderer::CmdSpeedRelativedSizeFactor::doGet(const void* target) const
    {
        return StringConverter::toString(
            static_cast<const BillboardParticleRenderer*>(target)->getSpeedRelativedSizeFactor());
    }
    void BillboardParticleRenderer::CmdSpeedRelativedSizeFactor::doSet(void* target, const String& val)
    {
        static_cast<BillboardParticleRenderer*>(target)->setSpeedRelativedSizeFactor(
