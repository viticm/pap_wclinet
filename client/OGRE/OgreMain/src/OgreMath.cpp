...
#undef _CALC_AXIS
    ...
    bool Math::intersects(const Plane& plane, const AxisAlignedBox& box)
    {
        ...
        Real dist = plane.getDistance(centre);
        // Calculate the maximise allows absolute distance for
        // the distance between box centre and plane
        Real maxAbsDist = plane.normal.absDotProduct(halfSize);

        // Absolute distance less than or equal maximise allows
        // absolute distance means intersection occurs
        return Math::Abs(dist) <= maxAbsDist;
    }
    //-----------------------------------------------------------------------
