...
namespace Ogre
{
    ...
    MeshManager::MeshManager()
        ...
        , mEnableAutoBuildAllMeshesEdgeLists(false)
    ...
    //-----------------------------------------------------------------------
    bool MeshManager::getPrepareAllMeshesForShadowVolumes(void) const
    {
        return mPrepAllMeshesForShadowVolumes;
    }
    //-----------------------------------------------------------------------
    void MeshManager::setEnableAutoBuildAllMeshesEdgeLists(bool enable)
    {
        mEnableAutoBuildAllMeshesEdgeLists = enable;
    }
    //-----------------------------------------------------------------------
    bool MeshManager::getEnableAutoBuildAllMeshesEdgeLists(void) const
    {
        return mEnableAutoBuildAllMeshesEdgeLists;
    }
    //-----------------------------------------------------------------------
