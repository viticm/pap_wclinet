...
namespace Ogre
{
    ...
    {
        return Matrix3(
            m[0][0]*rkMatrix.m[0][0] + m[0][1]*rkMatrix.m[1][0] + m[0][2]*rkMatrix.m[2][0],
            m[0][0]*rkMatrix.m[0][1] + m[0][1]*rkMatrix.m[1][1] + m[0][2]*rkMatrix.m[2][1],
            m[0][0]*rkMatrix.m[0][2] + m[0][1]*rkMatrix.m[1][2] + m[0][2]*rkMatrix.m[2][2],

            m[1][0]*rkMatrix.m[0][0] + m[1][1]*rkMatrix.m[1][0] + m[1][2]*rkMatrix.m[2][0],
            m[1][0]*rkMatrix.m[0][1] + m[1][1]*rkMatrix.m[1][1] + m[1][2]*rkMatrix.m[2][1],
            m[1][0]*rkMatrix.m[0][2] + m[1][1]*rkMatrix.m[1][2] + m[1][2]*rkMatrix.m[2][2],

            m[2][0]*rkMatrix.m[0][0] + m[2][1]*rkMatrix.m[1][0] + m[2][2]*rkMatrix.m[2][0],
            m[2][0]*rkMatrix.m[0][1] + m[2][1]*rkMatrix.m[1][1] + m[2][2]*rkMatrix.m[2][1],
            m[2][0]*rkMatrix.m[0][2] + m[2][1]*rkMatrix.m[1][2] + m[2][2]*rkMatrix.m[2][2]
            );
    }
    //-----------------------------------------------------------------------
