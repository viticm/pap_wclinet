...
namespace Ogre {
    ...
    //-----------------------------------------------------------------------
    void PatchSurface::build(const HardwareVertexBufferSharedPtr& destVertexBuffer, 
        size_t vertexStart, const HardwareIndexBufferSharedPtr& destIndexBuffer, size_t indexStart)
    {
