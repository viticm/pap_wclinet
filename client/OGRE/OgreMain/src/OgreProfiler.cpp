...
namespace Ogre {
    ...
    void Profiler::initialize() {
        ...
        for (uint i = 0; i < maxProfiles; ++i) {
            ...
            element = createTextArea("profileText" + StringConverter::toString(i), 90, mBarHeight, mGuiBorderWidth + (mBarHeight * 2) * i, 0, 14, StringUtil::BLANK, false);
            mProfileGui->addChild(element);
