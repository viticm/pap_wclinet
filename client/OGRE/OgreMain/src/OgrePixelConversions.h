...
struct R8G8B8A8toL8: public PixelConverter <uint32, uint8, FMTCONVERTERID(PF_R8G8B8A8, PF_L8)>
{
    inline static DstType pixelConvert(SrcType inp)
    {
        return (uint8)((inp&0xFF000000)>>24);
    }
};

struct L8toR8G8B8A8: public PixelConverter <uint8, uint32, FMTCONVERTERID(PF_L8, PF_R8G8B8A8)>
{
    inline static DstType pixelConvert(SrcType inp)
    {
        return 0x000000FF|(((unsigned int)inp)<<8)|(((unsigned int)inp)<<16)|(((unsigned int)inp)<<24);
...
// BYTE_LA to A8X8Y8Z8/X8Y8Z8A8
template <int id> struct LAtoA8X8Y8Z8: public PixelConverter <uint16, uint32, id>
{
    inline static DstType pixelConvert(SrcType inp)
    {
#if OGRE_ENDIAN == OGRE_ENDIAN_BIG
        return (((unsigned int)(inp&0x00FF))<<24) |
               (((unsigned int)(inp&0xFF00))>> 8) |
               (((unsigned int)(inp&0xFF00))<< 0) |
               (((unsigned int)(inp&0xFF00))<< 8);
#else
        return (((unsigned int)(inp&0xFFFF))<<16) |
               (((unsigned int)(inp&0x00FF))<< 0) |
               (((unsigned int)(inp&0x00FF))<< 8);
#endif
    }
};
template <int id> struct LAtoX8Y8Z8A8: public PixelConverter <uint16, uint32, id>
{
    inline static DstType pixelConvert(SrcType inp)
    {
#if OGRE_ENDIAN == OGRE_ENDIAN_BIG
        return (((unsigned int)(inp&0xFFFF))<< 0) |
               (((unsigned int)(inp&0xFF00))<< 8) |
               (((unsigned int)(inp&0xFF00))<<16);
#else
        return (((unsigned int)(inp&0xFF00))>> 8) |
               (((unsigned int)(inp&0x00FF))<< 8) |
               (((unsigned int)(inp&0x00FF))<<16) |
               (((unsigned int)(inp&0x00FF))<<24);
#endif
    }
};

typedef LAtoA8X8Y8Z8<FMTCONVERTERID(PF_BYTE_LA, PF_A8R8G8B8)> LAtoA8R8G8B8;
typedef LAtoA8X8Y8Z8<FMTCONVERTERID(PF_BYTE_LA, PF_A8B8G8R8)> LAtoA8B8G8R8;
typedef LAtoX8Y8Z8A8<FMTCONVERTERID(PF_BYTE_LA, PF_R8G8B8A8)> LAtoR8G8B8A8;
typedef LAtoX8Y8Z8A8<FMTCONVERTERID(PF_BYTE_LA, PF_B8G8R8A8)> LAtoB8G8R8A8;
...
{;
    switch(FMTCONVERTERID(src.format, dst.format))
    {
        ...
        CASECONVERTER(R8G8B8A8toL8);
        CASECONVERTER(L8toR8G8B8A8);
        CASECONVERTER(L8toL16);
        CASECONVERTER(L16toL8);
        CASECONVERTER(LAtoA8R8G8B8);
        CASECONVERTER(LAtoA8B8G8R8);
        CASECONVERTER(LAtoB8G8R8A8);
        CASECONVERTER(LAtoR8G8B8A8);
