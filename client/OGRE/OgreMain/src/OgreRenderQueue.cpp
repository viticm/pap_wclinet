...
namespace Ogre {
    ...
    RenderQueue::RenderQueue()
        ...
        , mEnableShadowsForUnregisteredGroup(true)
        ...
        mGroups.insert(
            RenderQueueGroupMap::value_type(
                ...
                new RenderQueueGroup(this,
                    ...
                    mEnableShadowsForUnregisteredGroup)
                )
            );
    ...
    //-----------------------------------------------------------------------
    void RenderQueue::setEnableShadowsForUnregisteredGroup(bool enable)
    {
        mEnableShadowsForUnregisteredGroup = enable;
    }
    //-----------------------------------------------------------------------
    bool RenderQueue::getEnableShadowsForUnregisteredGroup(void) const
    {
        return mEnableShadowsForUnregisteredGroup;
    }
	//-----------------------------------------------------------------------
