...
namespace Ogre {
    ...
    //---------------------------------------------------------------------
    void OverlayManager::parseNewElement( DataStreamPtr& stream, const String& elemType, const String& elemName, 
            bool isContainer, Overlay* pOverlay, bool isTemplate, const String& templateName, OverlayContainer* container)
    {
        String line;
