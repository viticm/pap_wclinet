    ...
    public:
		...
		*/
        ...
        /** Sets the texture blend modes from a TextureUnitState record.
            ...
            @param unit Texture unit as above
            @param colourBlendMode Details of the colour blending mode
            @param alphaBlendMode Details of the alpha blending mode
        */
        virtual void _setTextureBlendMode(size_t unit,
        ...
        */
        virtual void _setDepthBias(short bias) = 0;
