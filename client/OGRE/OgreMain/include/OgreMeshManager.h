    ...
    */
    ...
    public:
        ...
        */
        ...
        bool getPrepareAllMeshesForShadowVolumes(void) const;

        /** Tells the mesh manager that all future meshes should enable automatically
            build edge lists on loading.
        */
        void setEnableAutoBuildAllMeshesEdgeLists(bool enable);
        /** Retrieves whether all Meshes should enable automatically build edge lists. */
        bool getEnableAutoBuildAllMeshesEdgeLists(void) const;
    ...
    protected:
        ...
        */
        ...
        bool mEnableAutoBuildAllMeshesEdgeLists;
