...
namespace Ogre {
    ...
    */
    ...
    protected:
        ...
        void parseNewElement( DataStreamPtr& chunk, const String& elemType, const String& elemName, 
            bool isContainer, Overlay* pOverlay, bool isTemplate, const String& templateName = StringUtil::BLANK,
