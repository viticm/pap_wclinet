...
#define OGRE_MAX_NUM_BONES 256
    ...
    */
    ...
    public:
		...
		*/
		virtual void optimiseAllAnimations(bool respectsCurrentModeOnly = false, Real toleranceFactor = 0.05f);
		...
		*/
		...
		virtual ulong getManualBonesDirtyCounter(void) const { return mManualBonesDirtyCounter; }
	...
	protected:
		...
		/// Manual bones dirty?
		ulong mManualBonesDirtyCounter;
