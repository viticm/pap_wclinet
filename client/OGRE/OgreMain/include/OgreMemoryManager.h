...
void operator delete[](void *reportedAddress);
void *operator new(size_t reportedSize, const std::nothrow_t&) throw();
void *operator new[](size_t reportedSize, const std::nothrow_t&) throw();
void operator delete(void *reportedAddress, const std::nothrow_t&) throw();
void operator delete[](void *reportedAddress, const std::nothrow_t&) throw();
//-----------------------------------------------------------------------------
...
namespace Ogre {
	...
	*/
    class _OgreExport MemoryManager
    {
        ...
        friend void ::operator delete[](void*);
        friend void *::operator new(size_t reportedSize, const std::nothrow_t&) throw();
        friend void *::operator new[](size_t reportedSize, const std::nothrow_t&) throw();
        friend void ::operator delete(void *reportedAddress, const std::nothrow_t&) throw();
        friend void ::operator delete[](void *reportedAddress, const std::nothrow_t&) throw();
    ...
    public:
        ...
        void *op_new_sc( size_t reportedSize, unsigned processID, bool disableThrowException = false );
        void *op_new_vc( size_t reportedSize, unsigned processID, bool disableThrowException = false );

        void *op_new_sc( size_t reportedSize, const char *sourceFile, int sourceLine, unsigned processID, bool disableThrowException = false );
        void *op_new_vc( size_t reportedSize, const char *sourceFile, int sourceLine, unsigned processID, bool disableThrowException = false );
...
inline void *operator new(size_t reportedSize, const std::nothrow_t&) throw()
{
    if( !gProcessID )
        gProcessID = Ogre::MemoryManager::instance()._getProcessID();
    return Ogre::MemoryManager::instance().op_new_sc( reportedSize, gProcessID, true );
}
inline void *operator new[](size_t reportedSize, const std::nothrow_t&) throw()
{
    if( !gProcessID )
        gProcessID = Ogre::MemoryManager::instance()._getProcessID();
    return Ogre::MemoryManager::instance().op_new_vc( reportedSize, gProcessID, true );
}

inline void operator delete(void *reportedAddress, const std::nothrow_t&) throw()
{
    Ogre::MemoryManager::instance().op_del_sc( reportedAddress, gProcessID );    
}
inline void operator delete[](void *reportedAddress, const std::nothrow_t&) throw()
