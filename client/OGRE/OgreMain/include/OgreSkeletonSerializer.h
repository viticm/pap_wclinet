...
namespace Ogre {
    ...
    */
    ...
    private:
        ...
        void writeKeyFrameList(const Skeleton* pSkel, const NodeAnimationTrack* track);
        ...
        void readKeyFrameList(DataStreamPtr& stream, NodeAnimationTrack* track, Skeleton* pSkel);
        ...
        unsigned short calcKeyFrameListFlags(const NodeAnimationTrack* pTrack);
        size_t calcKeyFrameListSize(const Skeleton* pSkel, const NodeAnimationTrack* pTrack, unsigned short keyFrameFlags);
