    ...
    public:
		...
		*/
        ...
        /** Create an Entity (instance of a discrete mesh).
            ...
            @param
                suppressSkeletalAnimation If true, suppress skeletal animation for the entity,
                however, you can still starting skeletal animation later.
        */
        virtual Entity* createEntity(const String& entityName, const String& meshName, bool suppressSkeletalAnimation = false);
