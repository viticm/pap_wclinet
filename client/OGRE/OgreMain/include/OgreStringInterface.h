...
#define OGRE_STRING_INTERFACE_COPY 1
...
namespace Ogre {
    ...
    */
    ...
    protected:
        ...
        /// Param dictionary for this instance (must be initialised by subclasses)
        ...
        */
        ...
        @remarks
            ...
            used or performance).
        @par
            This is a overload version just for avoid construct String object in the caller.
        @param
            className the name of the class using the dictionary
        @returns
            true if a new dictionary was created, false if it was already there
        */
        bool createParamDictionary(const char* className);

    public:

        /** Default constructor */
        StringInterface(void) : mParamDict(0) {}
