    ...
    */
    ...
    public:
        ...
        */
        ...
        /** Clear/remove all custom parameters for this Renderable.
            @see setCustomParameter for full details.
        */
        void clearCustomParameters(void)
        {
            mCustomParameters.clear();
        }

        /** A map associates a numeric index with a 4-dimensional value, use to
            store of custom parameters of the Renderable.
        */
        typedef std::map<size_t, Vector4> CustomParameterMap;

        /** Sets all custom parameters for this Renderable.
            @see setCustomParameter for full details.
        @param parameters A map of custom parameters to associated with this Renderable.
        */
        void setCustomParameters(const CustomParameterMap& parameters)
        {
            mCustomParameters = parameters;
        }

        /** Gets all custom parameters associated with this Renderable.
            @see setCustomParameter for full details.
        @returns A map of custom parameters to associated with this Renderable.
        */
