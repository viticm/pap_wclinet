...
namespace Ogre {
    ...
    public:
		...
		*/
		...
		/** Sets any kind of user value on this instance.
		@remarks
			This method allows you to associate any user value you like with 
			this CompositorInstance. This can be a pointer back to one of your
            own classes for instance.
		*/
		void setUserAny(const Any& anything);

		/** Retrieves the custom user value associated with this instance.
		*/
