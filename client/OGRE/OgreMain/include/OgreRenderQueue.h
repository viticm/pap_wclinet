...
namespace Ogre {
    ...
    */
    ...
    protected:
        ...
        /// Whether shadows are enabled for unregistered group
        bool mEnableShadowsForUnregisteredGroup;
    ...
    public:
        ...
        */
        ...
        /** Sets whether or not enable shadows for unregistered group.
            The first time used group will enable shadows by the value
            specify by this function.
        */
        void setEnableShadowsForUnregisteredGroup(bool enable);

        /** Sets whether or not enable shadows for unregistered group.
            The first time used group will enable shadows by the value
            returns by this function.
        */
        bool getEnableShadowsForUnregisteredGroup(void) const;
