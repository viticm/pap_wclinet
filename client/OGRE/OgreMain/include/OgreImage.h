    ...
    */
    ...
    public:
        ...
        */
        ...
        /** Free-up the data allocated by this image
        */
        void freeData(void);
        ...
        */                 
        ...
        /** Stores a pointer to raw data in memory. The pixel format has to be specified.
            ...
            @param
                The data pointer, if NULL, the data will allocated internally and ignored autoDelete
            @param
				Width of image
            @param
				Height of image
		...
		/** Stores a pointer to raw data in memory. The pixel format has to be specified.
            @remarks
                ...
                The type can be determined by calling getFormat().             
            @param
                The data pointer, if NULL, the data will allocated internally
            @param
				Width of image
            @param
				Height of image
