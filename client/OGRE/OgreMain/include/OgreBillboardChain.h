	...
	*/
	...
	public:
		...
		*/
        ...
        virtual void setChainLoop(size_t chainIndex, bool loop);
        virtual bool getChainLoop(size_t chainIndex) const;
	...
	protected:
		...
		*/
		struct ChainSegment
		{
			...
			size_t tail;
            /// Whether or not the chain loops at the 'tail' and the 'head'
            bool loop;
		};
