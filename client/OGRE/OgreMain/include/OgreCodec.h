    ...
    */
    ...
    public:
        ...
        */
        ...
        {
            // Allows overridden, and lastest registered is available.
        ...
        */
        ...
        {
            CodecList::iterator it = ms_mapCodecs.find(pCodec->getType());
            if (it != ms_mapCodecs.end())
            {
                // Double-check in case overrided by other codec.
                if (it->second == pCodec)
                {
                    ms_mapCodecs.erase(it);
                }
            }
        }
