...
namespace Ogre {
    ...
    */
    ...
    {
    public:
        /// Normal constructor with length, all other parameters are use default value
	...
	typedef std::map<String, AnimationState*
        , std::less<String>
        , OgreFastPoolAllocator<std::pair<const String, AnimationState*> >
    > AnimationStateMap;
    ...
    typedef std::list<AnimationState*
        , OgreFastPoolAllocator<AnimationState*>
