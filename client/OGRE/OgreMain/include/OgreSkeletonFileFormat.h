    ...
    enum SkeletonChunkID {
        ...
        // A single animation for this skeleton
            ...
            // Repeating section (within SKELETON_ANIMATION)
                ...
                SKELETON_ANIMATION_TRACK_KEYFRAME_LIST = 0x4120,
                // A list keyframes within the track
                // Optional/Repeating section

                    // unsigned short numKeyFrames  : Number key frames
                    // unsigned short keyFrameFlags : Flags indicate which part of the keyframe are exists
