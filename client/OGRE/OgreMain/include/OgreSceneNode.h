    ...
    */
    ...
    public:
        ...
        */
        ...
        @remarks
            This function call SceneManager::destroySceneNode to destroy itself.
        @note
            Only scene node created by SceneManager::createSceneNode are destructible
            via this function, otherwise an exception will be throw.
        @see
