    ...
    */
    ...
    public:
        ...
        */
        ...
        /** Destroy this object.
        @remarks
            All objects created by engine are supposed to destroy by engine internal only,
            you can use this function to destroy them handily.
        @note
            Exception will be throw if this object isn't created by engine.
        @par
            For now only objects that created by SceneManager or MovableObjectFactory are
            destructible via this function.
        @see
            SceneManager::destroyMovableObject()
            MovableObjectFactory::destroyInstance()
        */
