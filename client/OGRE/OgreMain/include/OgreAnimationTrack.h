...
namespace Ogre 
{
    ...
    */
    ...
    public:
        ...
        */
		...
		/** Estimate the number of keyframes ahead of time.
		@remarks
			Calling this helps to avoid memory reallocation when you define
			keyframes.
		*/
		virtual void _estimateNumKeyFrames(unsigned short numKeyFrames);

        virtual KeyFrame* _createKeyFrameUnsorted(Real timePos);
        virtual void _sortKeyFrames(void);
        ...
        */
        virtual void apply(const TimeIndex& timeIndex, Real weight = 1.0, bool accumulate = false, 
			Real scale = 1.0f) = 0;
		...
		*/
		...
		virtual void optimise(bool respectsCurrentModeOnly, Real toleranceFactor) {}
    ...
    protected:
        ...
        /// Destroy a keyframe implementation - must be overridden
        virtual void destroyKeyFrameImpl(KeyFrame* kf) = 0;
	...
	*/
	...
	public:
        ...
        virtual NumericKeyFrame* _createNumericKeyFrameUnsorted(Real timePos);
	...
	protected:
        ...
        /// @copydoc AnimationTrack::destroyKeyFrameImpl
        void destroyKeyFrameImpl(KeyFrame* kf);
	...
	*/
	...
	public:
        ...
        virtual TransformKeyFrame* _createNodeKeyFrameUnsorted(Real timePos);
	...
	*/
	...
	public:
        ...
        /// Destructor
        virtual ~VertexAnimationTrack();

		/** Get the type of vertex animation we're performing. */
		VertexAnimationType getAnimationType(void) const { return mAnimationType; }

		virtual VertexMorphKeyFrame* _createVertexMorphKeyFrameUnsorted(Real timePos);
		virtual VertexPoseKeyFrame* _createVertexPoseKeyFrameUnsorted(Real timePos);
