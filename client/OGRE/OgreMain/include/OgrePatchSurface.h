...
namespace Ogre {
    ...
    */
    ...
    public:
        ...
        */
        void build(const HardwareVertexBufferSharedPtr& destVertexBuffer, size_t vertexStart,
            const HardwareIndexBufferSharedPtr& destIndexBuffer, size_t indexStart);
