...
enum {
  ...
  dGeomTransformClass,
  dTriMeshClass,
  // Terrain callback mod
  dTerrainCallbackClass,
...
// Terrain Callback mod (start)
typedef dReal dTerrainHeightCallback(void* data,dReal x,dReal z);
