...
namespace Ogre {
    ...
    void ColourFaderAffector::CmdRedAdjust::doCopy(void* target, const void* source)
    {
        static_cast<ColourFaderAffector*>(target)->setRedAdjust(
            static_cast<const ColourFaderAffector*>(source)->getRedAdjust());
    }
#endif
    //-----------------------------------------------------------------------
...
#if OGRE_STRING_INTERFACE_COPY
    void ColourFaderAffector::CmdGreenAdjust::doCopy(void* target, const void* source)
    {
        static_cast<ColourFaderAffector*>(target)->setGreenAdjust(
            static_cast<const ColourFaderAffector*>(source)->getGreenAdjust());
    }
#endif
    //-----------------------------------------------------------------------
...
#if OGRE_STRING_INTERFACE_COPY
    void ColourFaderAffector::CmdBlueAdjust::doCopy(void* target, const void* source)
    {
        static_cast<ColourFaderAffector*>(target)->setBlueAdjust(
            static_cast<const ColourFaderAffector*>(source)->getBlueAdjust());
    }
#endif
    //-----------------------------------------------------------------------
...
#if OGRE_STRING_INTERFACE_COPY
    void ColourFaderAffector::CmdAlphaAdjust::doCopy(void* target, const void* source)
    {
        static_cast<ColourFaderAffector*>(target)->setAlphaAdjust(
            static_cast<const ColourFaderAffector*>(source)->getAlphaAdjust());
    }
#endif
