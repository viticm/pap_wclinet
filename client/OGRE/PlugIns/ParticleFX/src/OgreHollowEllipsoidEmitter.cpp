...
namespace Ogre {
    ...
    void HollowEllipsoidEmitter::CmdInnerX::doCopy(void* target, const void* source)
    {
        static_cast<HollowEllipsoidEmitter*>(target)->setInnerSizeX(
            static_cast<const HollowEllipsoidEmitter*>(source)->getInnerSizeX());
    }
#endif
    //-----------------------------------------------------------------------
...
#if OGRE_STRING_INTERFACE_COPY
    void HollowEllipsoidEmitter::CmdInnerY::doCopy(void* target, const void* source)
    {
        static_cast<HollowEllipsoidEmitter*>(target)->setInnerSizeY(
            static_cast<const HollowEllipsoidEmitter*>(source)->getInnerSizeY());
    }
#endif
    //-----------------------------------------------------------------------
...
#if OGRE_STRING_INTERFACE_COPY
    void HollowEllipsoidEmitter::CmdInnerZ::doCopy(void* target, const void* source)
    {
        static_cast<HollowEllipsoidEmitter*>(target)->setInnerSizeZ(
            static_cast<const HollowEllipsoidEmitter*>(source)->getInnerSizeZ());
    }
#endif
