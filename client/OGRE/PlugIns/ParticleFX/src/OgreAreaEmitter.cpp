...
namespace Ogre {
    ...
    void AreaEmitter::CmdWidth::doCopy(void* target, const void* source)
    {
        static_cast<AreaEmitter*>(target)->setWidth(
            static_cast<const AreaEmitter*>(source)->getWidth());
    }
#endif
    //-----------------------------------------------------------------------
...
#if OGRE_STRING_INTERFACE_COPY
    void AreaEmitter::CmdHeight::doCopy(void* target, const void* source)
    {
        static_cast<AreaEmitter*>(target)->setHeight(
            static_cast<const AreaEmitter*>(source)->getHeight());
    }
#endif
    //-----------------------------------------------------------------------
...
#if OGRE_STRING_INTERFACE_COPY
    void AreaEmitter::CmdDepth::doCopy(void* target, const void* source)
    {
        static_cast<AreaEmitter*>(target)->setDepth(
            static_cast<const AreaEmitter*>(source)->getDepth());
    }
#endif
