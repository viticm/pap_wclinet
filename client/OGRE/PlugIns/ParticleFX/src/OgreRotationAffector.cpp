...
namespace Ogre {
    ...
    void RotationAffector::CmdRotationSpeedRangeEnd::doCopy(void* target, const void* source)
    {
        static_cast<RotationAffector*>(target)->setRotationSpeedRangeEnd(
            static_cast<const RotationAffector*>(source)->getRotationSpeedRangeEnd());
    }
#endif
    //-----------------------------------------------------------------------
...
#if OGRE_STRING_INTERFACE_COPY
    void RotationAffector::CmdRotationSpeedRangeStart::doCopy(void* target, const void* source)
    {
        static_cast<RotationAffector*>(target)->setRotationSpeedRangeStart(
            static_cast<const RotationAffector*>(source)->getRotationSpeedRangeStart());
    }
#endif
...
#if OGRE_STRING_INTERFACE_COPY
    void RotationAffector::CmdRotationRangeEnd::doCopy(void* target, const void* source)
    {
        static_cast<RotationAffector*>(target)->setRotationRangeEnd(
            static_cast<const RotationAffector*>(source)->getRotationRangeEnd());
    }
#endif
    //-----------------------------------------------------------------------
...
#if OGRE_STRING_INTERFACE_COPY
    void RotationAffector::CmdRotationRangeStart::doCopy(void* target, const void* source)
    {
        static_cast<RotationAffector*>(target)->setRotationRangeStart(
            static_cast<const RotationAffector*>(source)->getRotationRangeStart());
    }
#endif
}
