...
namespace Ogre {
    ...
    void ColourInterpolatorAffector::CmdColourAdjust::doCopy(void* target, const void* source)
    {
        static_cast<ColourInterpolatorAffector*>(target)->setColourAdjust(mIndex,
            static_cast<const ColourInterpolatorAffector*>(source)->getColourAdjust(mIndex));
    }
#endif
	//-----------------------------------------------------------------------
...
#if OGRE_STRING_INTERFACE_COPY
    void ColourInterpolatorAffector::CmdTimeAdjust::doCopy(void* target, const void* source)
    {
        static_cast<ColourInterpolatorAffector*>(target)->setTimeAdjust(mIndex,
            static_cast<const ColourInterpolatorAffector*>(source)->getTimeAdjust(mIndex));
    }
#endif
