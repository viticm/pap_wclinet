...
namespace Ogre {
    ...
    void RingEmitter::CmdInnerX::doCopy(void* target, const void* source)
    {
        static_cast<RingEmitter*>(target)->setInnerSizeX(
            static_cast<const RingEmitter*>(source)->getInnerSizeX());
    }
#endif
    //-----------------------------------------------------------------------
...
#if OGRE_STRING_INTERFACE_COPY
    void RingEmitter::CmdInnerY::doCopy(void* target, const void* source)
    {
        static_cast<RingEmitter*>(target)->setInnerSizeY(
            static_cast<const RingEmitter*>(source)->getInnerSizeY());
    }
#endif
