...
namespace Ogre {
    ...
    void ColourFaderAffector2::CmdRedAdjust1::doCopy(void* target, const void* source)
    {
        static_cast<ColourFaderAffector2*>(target)->setRedAdjust1(
            static_cast<const ColourFaderAffector2*>(source)->getRedAdjust1());
    }
#endif
...
#if OGRE_STRING_INTERFACE_COPY
    void ColourFaderAffector2::CmdRedAdjust2::doCopy(void* target, const void* source)
    {
        static_cast<ColourFaderAffector2*>(target)->setRedAdjust2(
            static_cast<const ColourFaderAffector2*>(source)->getRedAdjust2());
    }
#endif
    //-----------------------------------------------------------------------
...
#if OGRE_STRING_INTERFACE_COPY
    void ColourFaderAffector2::CmdGreenAdjust1::doCopy(void* target, const void* source)
    {
        static_cast<ColourFaderAffector2*>(target)->setGreenAdjust1(
            static_cast<const ColourFaderAffector2*>(source)->getGreenAdjust1());
    }
#endif
...
#if OGRE_STRING_INTERFACE_COPY
    void ColourFaderAffector2::CmdGreenAdjust2::doCopy(void* target, const void* source)
    {
        static_cast<ColourFaderAffector2*>(target)->setGreenAdjust2(
            static_cast<const ColourFaderAffector2*>(source)->getGreenAdjust2());
    }
#endif
    //-----------------------------------------------------------------------
...
#if OGRE_STRING_INTERFACE_COPY
    void ColourFaderAffector2::CmdBlueAdjust1::doCopy(void* target, const void* source)
    {
        static_cast<ColourFaderAffector2*>(target)->setBlueAdjust1(
            static_cast<const ColourFaderAffector2*>(source)->getBlueAdjust1());
    }
#endif
...
#if OGRE_STRING_INTERFACE_COPY
    void ColourFaderAffector2::CmdBlueAdjust2::doCopy(void* target, const void* source)
    {
        static_cast<ColourFaderAffector2*>(target)->setBlueAdjust2(
            static_cast<const ColourFaderAffector2*>(source)->getBlueAdjust2());
    }
#endif
    //-----------------------------------------------------------------------
...
#if OGRE_STRING_INTERFACE_COPY
    void ColourFaderAffector2::CmdAlphaAdjust1::doCopy(void* target, const void* source)
    {
        static_cast<ColourFaderAffector2*>(target)->setAlphaAdjust1(
            static_cast<const ColourFaderAffector2*>(source)->getAlphaAdjust1());
    }
#endif
...
#if OGRE_STRING_INTERFACE_COPY
    void ColourFaderAffector2::CmdAlphaAdjust2::doCopy(void* target, const void* source)
    {
        static_cast<ColourFaderAffector2*>(target)->setAlphaAdjust2(
            static_cast<const ColourFaderAffector2*>(source)->getAlphaAdjust2());
    }
#endif
    //-----------------------------------------------------------------------
...
#if OGRE_STRING_INTERFACE_COPY
    void ColourFaderAffector2::CmdStateChange::doCopy(void* target, const void* source)
    {
        static_cast<ColourFaderAffector2*>(target)->setStateChange(
            static_cast<const ColourFaderAffector2*>(source)->getStateChange());
    }
#endif
}
