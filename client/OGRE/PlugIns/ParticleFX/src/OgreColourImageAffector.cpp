...
namespace Ogre {
    ...
    void ColourImageAffector::CmdImageAdjust::doCopy(void* target, const void* source)
    {
        static_cast<ColourImageAffector*>(target)->setImageAdjust(
            static_cast<const ColourImageAffector*>(source)->getImageAdjust());
    }
#endif
