...
void _OgreTerrainExport StartOctreeSceneManager( void )
{
...
void _OgreTerrainExport ShutdownOctreeSceneManager( void )
{
...
void _OgreTerrainExport StopOctreeSceneManager( void )
{
    delete octreePlugin;
